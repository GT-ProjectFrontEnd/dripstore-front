                ...
                <main>
                    <section className="cart-1">
                        <div className="container-1">
                            ...
                            <div className="cart-items">
                                <div className="cart-item">
                                    <figure><img src="../src/image/tenis_revolution.png" alt="Tênis Nike Revolution 6 Next Nature Masculino"/></figure> 
                                ...
                                <div className="cart-item-actions">
                                    <div>
                                        <div> <button className="decrease">-</button>
                            ...
                            <div className='desc'>
                                <div className="coupon">
                                    ...
                                    <div className='inptDF'> <input type="text" placeholder="Insira seu código" className="coupon-code" />
                                ...
                                <div className="shipping">
                                    ...
                                    <div className='inptDF'><input type="text" placeholder="Insira seu CEP" className="shipping-cep" />
                                    <button className="btn">OK</button>
                                    </div>
                        ...
                        <div className="cart-summary">
                                ...
                                <ul>
                                    ...
                                    <li>Total: <span id="total" className="blink">R$ 219,00</span></li>
                                </ul>
                    ...
                    <section className="related-products">
                        <div className="container">
                            <div className='vtodos'><h2>Produtos Relacionados</h2>
